...
static void (*cef_server_create_ptr)(const cef_string_t* address, uint16 port, int backlog, cef_server_handler_t* handler);
...
static void cfx_load_cef_function_pointers(void *libcef) {
    ...
    cef_server_create_ptr = (void (*)(const cef_string_t*, uint16, int, cef_server_handler_t*))cfx_platform_get_fptr(libcef, "cef_server_create");
...
#define cef_server_create cef_server_create_ptr
